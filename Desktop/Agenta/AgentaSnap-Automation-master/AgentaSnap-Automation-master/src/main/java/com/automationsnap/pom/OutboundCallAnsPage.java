...
public class OutboundCallAnsPage {
	...
	private static Logger logger = LogManager
			.getLogger(OutboundCallAnsPage.class.getName());
	...
	@FindBy(id = "btn-xfer")
	public WebElement forwardandTransferBtn;
	...
	public void wrapUpReason_Click(String wrapUpStatusValue) {
		wrapUpDD_Click();
		WebElement wrapUpStatus = driver.findElement(By
				.xpath("//a[contains(text(),'" + wrapUpStatusValue + "')]"));
		wrapUpStatus.click();
		logger.debug("Select wrap up reason code");
	}

	@FindBy(id = "dialpad-call-button")
	private WebElement consultTransferButton;

	public void consultTransferButton_Click() {
		consultTransferButton.click();
		logger.debug("Click on call ConsultTransfer button");
	}
